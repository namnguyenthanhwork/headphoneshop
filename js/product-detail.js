...
document.querySelector('#view-all-description').addEventListener('click', () => {
    ...
    document.querySelector('#view-all-description').innerHTML = content.classList.contains('active') ? 'Thu gọn' : 'Xem chi tiết'
})
                ...
                <div class="product-card">
                    ...
                    <div class="product-card-info">
                        <div class="product-btn">
                            <a href="./product-detail.html" class="btn-flat btn-hover btn-shop-now">Đặt Ngay</a>
